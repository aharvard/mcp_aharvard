                ...
                <div className="max-w-6xl mx-auto px-6 py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            Plan your perfect trip based on how you're feeling!
                            Select your mood with big emoji buttons and discover
                            amazing destinations with beautiful animations.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
                        ...
                        <p className="text-gray-600 mb-6">
                            This section displays an interactive mood-based trip
                            planner interface as rendered by MCP-UI. Choose from
                            6 different moods with large emoji buttons, enjoy
                            smooth animations, and get personalized destination
                            recommendations!
                        </p>
                        ...
                        <div className="mb-4 p-4 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg border-l-4 border-purple-500">
                            ...
                            <ul className="text-sm text-purple-700 space-y-1">
                                <li>
                                    • Big emoji buttons with hover animations
                                </li>
