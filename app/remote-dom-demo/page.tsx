...
export default function RemoteDomDemoPage() {
    ...
    const handleUIAction = async (result: UIActionResult) => {
        console.log("⚾️UI Action received:", result);
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-300">
                            Experience the power of MCP-UI Remote DOM with
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                        ...
                        <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                            <p className="text-sm text-blue-800 dark:text-blue-200">
                                ...
                                page. To see the actual Remote DOM tool in
                                action, use the MCP server tool{" "}
                                <code className="bg-blue-100 dark:bg-blue-800 px-2 py-1 rounded">
                                    remote-dom-demo
                                </code>
                                with your preferred theme and advanced features
                                settings.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        ...
                        <div className="prose dark:prose-invert max-w-none">
                            <p className="text-gray-600 dark:text-gray-300 mb-4">
                                Remote DOM is a powerful feature of MCP-UI that
                                allows servers to define interactive UI
                                components that are rendered using the host's
                                native component library. This approach
                                provides:
                            </p>
                            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                                <li>
                                    <strong>Security:</strong> Server scripts
                                    run in sandboxed environments
                                </li>
                                <li>
                                    <strong>Integration:</strong> UIs match the
                                    host application's look and feel
                                </li>
                                <li>
                                    <strong>Interactivity:</strong> Components
                                    can communicate with the host via
                                    postMessage
                                </li>
                                <li>
                                    <strong>Flexibility:</strong> Dynamic
                                    content updates and theme switching
                                </li>
                                <li>
                                    <strong>Performance:</strong> Efficient
                                    rendering using the host's component system
                                </li>
                            </ul>
                        </div>
                    </div>
