                ...
                <div className="max-w-6xl mx-auto px-6 py-16">
                    ...
                    <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
                        ...
                        <p className="text-gray-600 mb-6">
                            ...
                            interface as rendered by MCP-UI. The content below
                            is generated from an MCP-UI resource that can be
                            embedded in any MCP client.
                        </p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600">
                                Execute specific tools and functions with
                                parameter passing
                            </p>
                        </div>
                        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600">
                                Send prompts to AI models and receive
