            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
                <div className="container mx-auto px-6 py-16 max-w-7xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
                        ...
                        <Link href="/pick-seat" className="group block">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border border-gray-100 hover:border-green-200 overflow-hidden">
                                ...
                                <div className="relative">
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        Preview an MCP-UI resource that provides
                                        an interactive seat picker with visual
                        ...
                        <Link href="/ui-actions" className="group block">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border border-gray-100 hover:border-purple-200 overflow-hidden">
                                ...
                                <div className="relative">
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        Preview an MCP-UI resource that
                                        demonstrates different types of message
                        ...
                        <Link href="/mood-trip-planner" className="group block">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border border-gray-100 hover:border-pink-200 overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-pink-50/50 via-transparent to-purple-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                <div className="relative">
                                    <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
                                        <Sparkles className="w-8 h-8 text-white" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-gray-900 group-hover:text-pink-600 transition-colors duration-200">
                                        Mood Trip Planner
                                    </h3>
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        Plan your perfect trip based on your
                                        mood! Big emoji buttons, smooth
                                        animations, and personalized destination
                                        reveals.
                                    </p>
                        ...
                        <Link
                            href="/typography-specimens"
                            className="group block"
                        >
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border border-gray-100 hover:border-indigo-200 overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/50 via-transparent to-violet-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                <div className="relative">
                                    <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
                                        <Type className="w-8 h-8 text-white" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-gray-900 group-hover:text-indigo-600 transition-colors duration-200">
                                        Typography Specimens
                                    </h3>
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        Explore beautiful open-source typefaces
                                        from Google Fonts with weight scales,
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl p-12 mb-16 border border-gray-100">
                        ...
                        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                            This is a sandbox for exploring and showcasing
                            MCP-UI examples. It provides a hands-on environment
                            to test and visualize the capabilities of Model
                            Context Protocol UI components.
                        </p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-gray-700">
                                        View UI components that can be rendered
                                        by MCP-UI clients
                                    </p>
                                </div>
                                <div className="flex items-start gap-3">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-gray-700">
                                        Debug message passing between MCP
                                        servers and UI clients
                                    </p>
                                </div>
                            </div>
                            <div className="space-y-4">
