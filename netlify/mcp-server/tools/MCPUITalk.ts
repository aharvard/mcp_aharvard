...
export function MCPUITalk(START_SLIDE = 8) {
...
<article class="mcp-ui-container" data-theme="dark">
  ...
  <div class="progress" style="--percent-progress: 50%;"></div>
  ...
  <script>
    ...
    const setProgressBar = () => progressBar.setAttribute('style', "--percent-progress: " + (currentSlideIndex) / slideCount * 100 + "%")
    setProgressBar();
